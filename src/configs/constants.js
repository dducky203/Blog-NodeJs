...
/*export const DATABASE_URL =
    "mongodb+srv://" + process.env.DB_USERNAME + ":" + process.env.DB_PASSWORD + "@cluster0.1hlhhbl.mongodb.net/"
...
export const JOI_DEFAULT_MESSAGE = {
    ...
    "string.only": "{{#label}} chỉ được {{#limit}} ký tự. .",
    ...
    "any.noExists": "{{#label}} không tồn tại.",
};
